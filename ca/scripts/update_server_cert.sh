...
#todo: Create also new private key
openssl req -new -config $CA_BASEDIR/conf/est_server_cert.cnf -key $EST_BASEDIR/certs/serverkey.pem -out $CA_BASEDIR/csr_dir/servercert.csr -outform PEM
#And sign it
